...
alpha_metrics_set2<-reshape2::melt(alpha_metrics_set,c("assemblageID", "YEAR"))
alpha_slopes_set <- subset(alpha_slopes, assemblageID == "18_335699")

alpha_metrics_set1<-merge(alpha_metrics_set2,alpha_slopes_set, by.x = c("assemblageID", "variable"), by.y=c("assemblageID", "metric"))
