...
```{r gridding_ex, eval=TRUE, cache=TRUE, echo=FALSE, message=FALSE, tidy=TRUE, include=TRUE} 
...
alphaSl <- alSl %>% separate(rarefyID,
...
```{r plot_alpha_shannon_ind, fig.width=12, fig.height=10, eval=FALSE, cache = TRUE, tidy=TRUE}
plotSlopes(x = ameta, metric = "Shannon", cols = scale_color_biotime(),
           taxa = "Fish", method = "ind", rf = "53_10639590", divType = "alpha")
```


```{r plot_alpha_shannon_metric, fig.width=8, fig.height=6, eval=FALSE, cache = TRUE, tidy=TRUE}
plotSlopes(x = ameta, metric = "Shannon", cols = bioCol, taxa = "Fish", 
           method = "metric", rf = "53_10639590", divType = "alpha")
```

```{r plot_beta_jaccard_ind, fig.width=9, fig.height=6, eval=FALSE, cache = TRUE, tidy=TRUE}
plotSlopes(x = bmeta, metric = "JaccardDiss", cols = bioCol, taxa = "Fish",
           method = "ind", rf = "18_9044316", divType = "beta")
```

```{r plot_beta_jaccard_taxa, fig.width=8, fig.height=4, eval=FALSE, cache = TRUE, tidy=TRUE}
plotSlopes(x = bmeta, metric = "JaccardDiss", cols = bioCol, taxa = "Fish",
           method = "taxa", rf = "53_10639590", divType = "alpha")
```
