...
When loading the BioTIMEr package, the BioTIME data is automatically loaded too.
There are two files: 
...
ameta <- left_join(alphaSl, meta2, by = "STUDY_ID")
...
bmeta <- left_join(betaSl, meta2, by = "STUDY_ID")
