...
plotSlopes(x = ameta, metric = "Shannon", cols = bioCol,
           taxa = "Fish", method = "ind", assemblageID = "10_9675315", divType = "alpha")
```


```{r plot_alpha_shannon_metric, fig.width=8, fig.height=6, eval=FALSE, cache=TRUE, tidy=TRUE}
plotSlopes(x = ameta, metric = "Shannon", cols = bioCol, taxa = "Fish", method = "metric", assemblageID = "10_9675315", divType = "alpha")
```
...
plotSlopes(x = bmeta, metric = "JaccardDiss", cols = bioCol, taxa = "Fish",
           method = "ind", assemblageID = "10_9675315", divType = "beta")
```
...
plotSlopes(x = bmeta, metric = "JaccardDiss", cols = bioCol,
           taxa = "Fish",
           method = "taxa", assemblageID = "10_9675315", divType = "beta")
```
