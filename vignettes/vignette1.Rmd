...
```{r resampling_ex, cache=TRUE, echo=TRUE, message=FALSE, tidy=TRUE, include=FALSE} 
...
```{r resampling_ex1, cache=TRUE, echo=TRUE, message=FALSE, tidy=TRUE, include=FALSE} 
#let's apply it then:
...
```{r resampling_ex12, cache=TRUE, echo=TRUE, message=FALSE, tidy=TRUE, include=FALSE} 
...
```{r metrics, cache=TRUE, echo=TRUE, message=FALSE, fig.width=7, fig.height=3,tidy=TRUE, include=FALSE, figures='hold'} 
...
```{r trends2, cache=TRUE, echo=TRUE, message=FALSE, fig.width=10, fig.height=7,tidy=FALSE, include=FALSE} 
...
ggplot(data = alpha_slopes_set2, aes(x = YEAR, y = diversity)) +
  ...
  stat_smooth(data = subset(alpha_slopes_set2, alpha_slopes_set2$significance == 1), #color only trends that are significant
