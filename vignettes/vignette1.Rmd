...
alpha_slopes$metric <- factor(alpha_slopes$metric, levels = c("S", "N", "maxN", "Shannon","expShannon", "Simpson", "invSimpson", "PIE", "DomMc"))
...
# Sort the data
beta_slopes$metric <- factor(beta_slopes$metric, levels = c("JaccardDiss", "MorisitaHornDiss", "BrayCurtisDiss"))
