...
```{r bt_package_loading, cache=FALSE}
...
# grid_rare <- resampling( x= grid_samples_test, measure ="BIOMASS", n_resamples = 1, conservative = FALSE)
```
...
```{r fig-trends, fig.width=7.2, fig.height=5}
...
```{r fig-trends2, fig.width=7.2, fig.height=1.9}
...
```{r fig-trends6, fig.width=7.2, fig.height=2.3}
...
```{r fig-trends8, fig.width=7.2, fig.height=5}
